...
def analyze_stock(request: Request, req: AIAnalysisRequest, current_user: str = Depends(get_current_user)):
    ...
    from i18n import normalize_lang, build_analysis_system_prompt
    lang = normalize_lang(req.lang)
    system_prompt = build_analysis_system_prompt(lang)
    ...
    try:
        ...
        deep_data = run_deep_analysis(req.ticker, include_sentiment=False, lang=lang)
